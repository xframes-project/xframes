 ...
 * Source: react-native@0.87.0/Libraries/Renderer/implementations/ReactFabric-dev.js
 * Source SHA-256: 873ef19f4dfbb385f43ad6ec510e2ab00168289f72becba703111652008ddf94
        ...
        (function () {
                            ...
                            for (var eventName in pluginIndex) {
                                ...
                                if ((eventName$jscomp$0 = dispatchConfig.phasedRegistrationNames)) {
                                    for (JSCompiler_inline_result in eventName$jscomp$0)
                                        eventName$jscomp$0.hasOwnProperty(
                                            JSCompiler_inline_result,
                                        ) &&
                                    ...
                                    if (
                                        ...
                                        if (nextValue.$$typeof === REACT_ELEMENT_TYPE) {
                                            ...
                                            var prevKind = Object.prototype.toString.call(key),
                                                nextKind =
                                                    Object.prototype.toString.call(nextValue);
                                            if (
                                                prevKind === nextKind &&
            ...
            function logComponentRender(fiber, startTime, endTime, wasHydrated, committedLanes) {
                ...
                if (null !== name && supportsUserTiming) {
                    ...
                    null !== props && null !== alternate && alternate.memoizedProps !== props
            ...
            function logSuspendedRenderPhase(startTime, endTime, lanes, debugTask) {
                !supportsUserTiming ||
                    endTime <= startTime ||
                    ((lanes = (lanes & 738197653) === lanes ? "tertiary-dark" : "primary-dark"),
                    debugTask
                        ? debugTask.run(
                              console.timeStamp.bind(
                                  console,
            ...
            function logCommitErrored(startTime, endTime, errors, passive, debugTask) {
                if (supportsUserTiming && !(endTime <= startTime)) {
                    ...
                    debugTask
                        ? debugTask.run(performance.measure.bind(performance, "Errored", startTime))
            ...
            function throwOnInvalidObjectType(returnFiber, newChild) {
                ...
                null !== debugTask
                    ? debugTask.run(throwOnInvalidObjectTypeImpl.bind(null, returnFiber, newChild))
            ...
            function finishClassComponent(
                ...
                else if (((Component = callRenderInDEV(shouldUpdate)), workInProgress.mode & 8)) {
                    setIsStrictModeForDevtools(!0);
                    try {
            ...
            function beginWork(current, workInProgress, renderLanes) {
                ...
                switch (workInProgress.tag) {
                    ...
                    case 31:
                        ...
                        else if (((returnFiber = current.memoizedState), null !== returnFiber))
                            b: {
                                pushDehydratedActivitySuspenseHandler(workInProgress);
                                if (nextProps) {
                            ...
                            switch (firstChild.tag) {
                                case 0:
                                    if (
                                        ...
                                        (firstChild =
                                            null !== firstChild ? firstChild.events : null),
                                        null !== firstChild)
                                    )
            ...
            function commitPassiveMountOnFiber(
                ...
                switch (finishedWork.tag) {
                    ...
                    case 22:
                        ...
                        null !== finishedWork.memoizedState
                            ? wasInHydratedSubtree._visibility & OffscreenPassiveEffectsConnected
                                ? recursivelyTraversePassiveMountEffects(
                                      finishedRoot,
                                      finishedWork,
                                      committedLanes,
            ...
            function commitPassiveUnmountOnFiber(finishedWork) {
                ...
                switch (finishedWork.tag) {
                    ...
                    case 22:
                        ...
                        null !== finishedWork.memoizedState &&
                        prevProfilerEffectDuration._visibility & OffscreenPassiveEffectsConnected &&
            ...
            function performWorkOnRoot(root, lanes, forceSync) {
                ...
                var exitStatus = (forceSync =
                    (!forceSync && 0 === (lanes & 127) && 0 === (lanes & root.expiredLanes)) ||
                ...
                do {
                    if (exitStatus === RootInProgress) {
                        ...
                        if (startTime && !isRenderConsistentWithExternalStores(yieldEndTime)) {
            ...
            function prepareFreshStack(root, lanes) {
                ...
                0 !== (lanes & 4194048) &&
                    ...
                    supportsUserTiming &&
                        ...
                        0 < previousRenderStartTime
                            ? previousRenderStartTime > color && (previousRenderStartTime = color)
                ...
                previousRenderStartTime !== noTimeout &&
                    ((root.timeoutHandle = noTimeout), cancelTimeout(previousRenderStartTime));
                ...
                1e3 < root - lastResetTime &&
                    ((ReactSharedInternals.recentlyCreatedOwnerStacks = 0), (lastResetTime = root));
            ...
            function markRenderDerivedCause(fiber) {
                null === workInProgressUpdateTask &&
                    (workInProgressUpdateTask = null == fiber._debugTask ? null : fiber._debugTask);
            }
            ...
            obj.createPortal = function (children, containerTag) {
            ...
            obj.dispatchCommand = function (handle, command, args) {
                var nativeTag =
            ...
            obj.findHostInstance_DEPRECATED = function (componentOrHandle) {
                var owner = current;
                null !== owner &&
                    isRendering &&
                    null !== owner.stateNode &&
            ...
            obj.findNodeHandle = findNodeHandle;
            obj.getNodeFromInternalInstanceHandle = getNodeFromInternalInstanceHandle;
            obj.getPublicInstanceFromInternalInstanceHandle = function (internalInstanceHandle) {
            ...
            obj.getPublicInstanceFromRootTag = function (rootTag) {
                return (rootTag = roots.get(rootTag)) ? rootTag.containerInfo.publicInstance : null;
            };
            obj.isChildPublicInstance = function (parentInstance, childInstance) {
                if (
            ...
            obj.render = function (element, containerTag, callback, concurrentRoot, options) {
            ...
            obj.sendAccessibilityEvent = function (handle, eventType) {
                var nativeTag =
                    null != handle._nativeTag
                        ? handle._nativeTag
                        : ReactNativePrivateInterface.getNativeTagFromPublicInstance(handle);
            ...
            obj.stopSurface = function (containerTag) {
                var root = roots.get(containerTag);
                root &&
            ...
            obj.unmountComponentAtNode = function (containerTag) {
