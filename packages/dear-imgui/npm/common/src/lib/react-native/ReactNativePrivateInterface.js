...
const attributesForElements = {
    ...
    "plot-bar": ["axisAutoFit", "dataPointsLimit", "xAxisLabel", "yAxisLabel"],
    "plot-heatmap": ["axisAutoFit", "scaleMin", "scaleMax", "colormap", "xAxisLabel", "yAxisLabel"],
    "plot-scatter": ["axisAutoFit", "dataPointsLimit", "xAxisLabel", "yAxisLabel"],
    "plot-line": [
        "xAxisDecimalDigits",
        "yAxisDecimalDigits",
        "xAxisScale",
    ...
    "plot-candlestick": ["axisAutoFit", "bullColor", "bearColor", "dataPointsLimit", "xAxisLabel", "yAxisLabel"],
