 ...
 * Source: react-native@0.87.0/Libraries/Renderer/implementations/ReactFabric-prod.js
 * Source SHA-256: 6f53e433d921c0090d0610c5a0091d0b3acb53d13f5d48c32d1e40bfac4bdfda
...
export default (ReactNativePrivateInterface) => {
    ...
    for (pluginName$jscomp$inline_279 in injectedNamesToPlugins$jscomp$inline_277)
        if (injectedNamesToPlugins$jscomp$inline_277.hasOwnProperty(pluginName$jscomp$inline_279)) {
            ...
            if (
                ...
                namesToPlugins[pluginName$jscomp$inline_279] !== pluginModule$jscomp$inline_280
            ) {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        if (showFallback) {
            ...
            null !== currentFallbackChildFragment
                ? (showFallback = createWorkInProgress(currentFallbackChildFragment, showFallback))
                : ((showFallback = createFiberFromFragment(
                      showFallback,
                      nextPrimaryChildren,
                      renderLanes,
        ...
        if (0 === (workInProgress.mode & 1)) workInProgress.memoizedState = null;
            ...
            switch (revealOrder) {
                ...
                case "unstable_legacy-backwards":
                    ...
                    initSuspenseListRenderState(workInProgress, !0, renderLanes, null, tailMode, 0);
                    break;
                case "together":
    ...
    function getPublicInstance(instance) {
        ...
        return null != instance.containerInfo && null != instance.containerInfo.publicInstance
    ...
    if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
        ...
        if (!hook$jscomp$inline_1553.isDisabled && hook$jscomp$inline_1553.supportsFiber)
            try {
                (rendererID = hook$jscomp$inline_1553.inject(internals$jscomp$inline_1245)),
    ...
    obj.findNodeHandle = function (componentOrHandle) {
    ...
    obj.getNodeFromInternalInstanceHandle = function (internalInstanceHandle) {
        return (
            internalInstanceHandle &&
    ...
    obj.isChildPublicInstance = function () {
