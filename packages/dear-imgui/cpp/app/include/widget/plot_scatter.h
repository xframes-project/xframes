...
class PlotScatter final : public StyledWidget {
private:
...
public:
    static std::unique_ptr<PlotScatter> makeWidget(const json& widgetDef, std::optional<WidgetStyle> maybeStyle, XFrames* view) {
        ...
        std::string legendLabel = "scatter-plot";
        ...
        auto widget = std::make_unique<PlotScatter>(view, id, axisAutoFit, dataPointsLimit, xAxisLabel, yAxisLabel, maybeStyle);
